    ...
    showMessage: function(msg) {
        ...
        if (msg.type === "html")
            $('#bodyFrame').load(function() {
                ...
                // now we need to set the inner height
                $('#bodyFrame').ready(function() {
                    var h = $('#bodyFrame').contents().find('body').height();
                    dump(h+"\n");
                    $('#bodyFrame').height((h+20)+"px");
                });
                $('#bodyFrame').resize(function() {
                    var h = $('#bodyFrame').contents().find('body').height();
                    dump(h+"\n");
                    $('#bodyFrame').height((h+20)+"px");
                });
